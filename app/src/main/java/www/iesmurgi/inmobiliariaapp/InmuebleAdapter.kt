...
class InmuebleAdapter(val context: Context,private var inmuebles:MutableList<Inmueble>)  :RecyclerView.Adapter<InmuebleAdapter.InmuebleHolder>() {
    ...
    class InmuebleHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        val tvTitulo : TextView = itemView.findViewById(R.id.titulo_textview)
        val tvPrecio : TextView = itemView.findViewById(R.id.precio_textview)
        val tvDescripcion : TextView = itemView.findViewById(R.id.descripcion_textview)
        val tvMetros : TextView = itemView.findViewById(R.id.metros_textview)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): InmuebleHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.esqueleto_inmueble, parent, false)
    ...
    override fun onBindViewHolder(holder: InmuebleHolder, position: Int) {
        ...
        val inmuebleApiService = InmuebleApiService.retrofit.create(InmuebleApiService::class.java)
