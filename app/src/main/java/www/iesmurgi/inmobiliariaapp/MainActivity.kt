...
import www.iesmurgi.inmobiliariaapp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bind.rvInmuebles.adapter = adapter
        bind.rvInmuebles.layoutManager = LinearLayoutManager(applicationContext)
        ...
        bind.rvInmuebles.addOnScrollListener(object : RecyclerView.OnScrollListener() {
    ...
    private fun loadInmuebles(inmuebleApiService: InmuebleApiService) {
        isLoading = true
